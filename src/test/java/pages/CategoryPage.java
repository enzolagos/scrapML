...
public class CategoryPage {
    ...
    //    return new Button(By.xpath("(//ol[contains(@class,\"ui-search-layout\")]//div[contains(@class,\"ui-search-result__content-wrapper\")])[position]//div"));
        return new Button(By.xpath("(//ol[contains(@class,\"ui-search-layout\")]/li//a[contains(@class,\"shops__items-group-details ui-search-link\")])[" + position + "]"));
